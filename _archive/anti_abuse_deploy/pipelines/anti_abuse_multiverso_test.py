...
SCORING = {
    ...
    "bot_speed":      {"threshold": 5.0, "points": 30},  # TESTE — voltar para 1.0 em producao
...
RISK_THRESHOLD_MEDIUM = 20   # TESTE — voltar para 35 em producao
RISK_THRESHOLD_HIGH   = 25   # TESTE — voltar para 55 em producao
...
def export_json(df: pd.DataFrame):
    """Exporta resultado em JSON com timestamp."""
    ...
    # Converte timestamps para string (JSON não serializa datetime nativo)
