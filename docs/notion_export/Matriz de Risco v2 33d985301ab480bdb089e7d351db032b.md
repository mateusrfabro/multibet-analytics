...
### Não-empilhamento de tags

- Quando um jogador é flagrado simultaneamente como **Saque Rápido** e **Cashout & Run**, apenas o **Cashout & Run** entra no cálculo do score. Evita penalidade dupla (-50) por uma mesma narrativa de "sacar e sumir".
...
> Depositou e sacou em 30 minutos (-25), usou bônus e sumiu (-25, sobrepõe e desativa o Saque Rápido), só deposita em promos (-15), encadeia promos (-10). Total bruto: -50. Score normalizado: 0.
> 
...
| --- | --- | --- |
| **~~v2.0~~** | ~~Integração automática com CRM via API~~ | **Entregue (abril/2026)** |
| **~~v2.1~~** | ~~Ajustes de discriminação: endurecimento de tags genéricas (Slot Player, Sustentado, Reinvestidor, Saque Rápido), revival de Zero Risco, correção de compliance do Alerta RG, não-empilhamento Saque Rápido + Cashout & Run~~ | **Entregue (maio/2026)** |
